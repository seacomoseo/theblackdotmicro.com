...
- If new project (not fork):
  - Copy [theblackdotmicro.com project files](https://github.com/theblackdotmicro/theblackdotmicro.com)
...
- `README.md` ⏩ edit baseURL ("theblackdotmicro.com") + delete steps bit by bit
- Design
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/theblackdotmicro/domains)
  - `Set up a custom domains`
  - `theblackdotmicro.com`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.theblackdotmicro.com`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/theblackdotmicro/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de theblackdotmicro.com`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/theblackdotmicro/forms)
...
1. [Servicios theblackdotmicro.com](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
